...
function Header() {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-40 bg-chrome text-chrome-fg transition-shadow duration-200",
      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center gap-4 px-5 sm:h-[4.25rem] sm:px-8">
        ...
        <div className="ms-auto flex items-center gap-1 lg:ms-4">
          ...
          <a
            ...
            className="hidden h-11 items-center gap-2 rounded-md px-3 text-sm text-chrome-fg hover:bg-chrome-fg/10 sm:inline-flex"
          >
          ...
          <nav className="grid gap-1" aria-label="Mobile">
            {NAV.map((item) => (
              <Link
                key={item.to}
                to={item.to}
                className="rounded-md px-3 py-3 text-base text-chrome-fg hover:bg-chrome-fg/10"
              >
                {t.nav[item.key]}
              </Link>
            ))}
  ...
  return (
    <footer className="mt-auto bg-chrome text-chrome-fg">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-4">
        ...
        <div>
          <p className="text-[11px] font-medium uppercase tracking-[0.18em] text-chrome-muted">
            {t.nav.contact}
          </p>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            ...
            <li>
              <a href={COMPANY.instagram} className="hover:text-brand">
                Instagram
              </a>
            </li>
            <li>
              <a href={COMPANY.facebook} className="hover:text-brand">
                Facebook
              </a>
            </li>
          </ul>
      ...
      <div className="border-t border-chrome-fg/10 bg-paper text-ink">
        <p className="mx-auto max-w-6xl px-5 py-6 text-xs leading-relaxed text-quiet sm:px-8">
          {t.footer.disclaimer}
        </p>
      </div>
    </footer>

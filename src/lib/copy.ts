...
export const copy: Record<Lang, Copy> = {
  ...
  en: {
    ...
    steps: [
      { t: "Pick a model", d: "Browse Toyota and Honda, choose a trim and color." },
      { t: "Talk to us", d: "WhatsApp or the form — we reply with availability." },
      { t: "Delivery", d: "Registration, finance or lease, handover in Jerusalem." },
    ],
    ...
    footer: {
      ...
      social: "Links",
      disclaimer:
        "Images are for illustration. Specs, colors and trims depend on model year and import availability. This site is not a price list — every quote is personal.",
    },
    toyotaTitle: "2026 Toyota",
    toyotaSub:
      "US parallel import — Grand Highlander, Sienna, Camry, 4Runner, RAV4 Plug-in Hybrid, Land Cruiser and Sequoia.",
    ...
    values: [
      { t: "Transparency", d: "The real spec, no surprises at delivery." },
      { t: "Support", d: "Hebrew and English — from choice to registration." },
      { t: "Backing", d: "Finance and lease when you need them, not as a push." },
    ],
    financeKicker: "Financing",
    financeTitle: "Finance that fits the car",
    financeSub:
      "We work with lenders. Rate, down payment and term are set after underwriting. We do not publish rates here.",
    financeItems: [
      { t: "Private purchase", d: "Finance for a new parallel-import vehicle, with flexible down-payment options." },
      { t: "Visa path", d: "Visa-holder benefits where eligible — confirmed in the office." },
    ...
    leaseItems: [
      { t: "Private", d: "Family models — Sienna, Grand Highlander, Odyssey." },
      { t: "Business", d: "Invoicing and small-fleet handling after a call." },
      { t: "Flexible", d: "Term and mileage around real use, not a template." },
    ],
    ...
    notFound: { title: "Page not found", body: "Head home or back to the models." },
  },
};

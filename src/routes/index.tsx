    ...
    <main>
      ...
      <section className="bg-chrome text-chrome-fg">
        <div className="mx-auto flex max-w-6xl items-end justify-between px-5 pt-10 sm:px-8">
          ...
          <Link
            to="/toyota"
            className="hidden items-center gap-2 text-sm text-chrome-muted hover:text-chrome-fg sm:inline-flex"
          >
            {t.heroSecondary}
            <Arrow className="size-4" />
          </Link>
      ...
      <section className="grid bg-chrome text-chrome-fg md:grid-cols-2">
        <Link
          to="/toyota"
          className="group relative isolate min-h-72 overflow-hidden border-b border-chrome-fg/10 md:border-b-0 md:border-e"
        >
          {toyotaHero ? (
            <img
              ...
              alt=""
              referrerPolicy="no-referrer"
              className="absolute inset-0 size-full object-contain object-center opacity-80 transition-transform duration-500 group-hover:scale-105"
            />
          ) : null}
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-px bg-rule sm:grid-cols-4">
          {t.trust.map((item) => (
            <div key={item.n} className="bg-paper px-5 py-8 sm:px-8">
              <p className="text-2xl font-medium text-ink">{item.n}</p>
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-6 text-sm text-muted">
            {lang === "he" ? COMPANY.addressHe : COMPANY.addressEn}
          </p>
